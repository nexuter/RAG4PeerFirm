...
class FileManager:
    ...
    def get_filing_path(self, cik_ticker: str, year: str, filing_type: str, 
    ...
    def get_item_path(self, cik_ticker: str, year: str, filing_type: str, 
                     item_number: str) -> str:
        """
        ...
        path = os.path.join(self.base_dir, cik_ticker, year, filing_type, 
                           "items", filename)
        return path
    
    def create_directory_structure(self, cik_ticker: str, year: str, 
